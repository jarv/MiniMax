...
-- - blame.nvim - Inline git blame sidebar
...
later(function()
  add({ 'https://github.com/dfendr/clipboard-image.nvim' })
...
-- Inline git blame showing commit info per line in a sidebar-style view.
-- Toggle with `:BlameToggle` or the keymap below.
--
-- Commands:
-- - :BlameToggle - Toggle blame sidebar
--
-- See also:
